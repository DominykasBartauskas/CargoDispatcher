    ...
    <>
      ...
      >
        <span className="label">
          List what each port sends out · a linked drone flies it to the paired port · drag ⠿ to reorder
        </span>
        ...
        return (
          ...
          >
            <div className="cardhead">
              <span className="draghandle" title="Drag to reorder" {...handleProps(p.id)}>
                ⠿
              </span>
              <button
