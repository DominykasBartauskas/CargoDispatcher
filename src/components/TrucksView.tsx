    ...
    <>
      ...
      >
        <span className="label">
          Pick a vehicle type · fluid trucks carry one fluid, the rest carry solids · drag ⠿ or ↑↓ to reorder
        </span>
        ...
        return (
          ...
          >
            <div className="cardhead">
              <ReorderHandle handle={handleProps(tk.id)} move={moveProps(tk.id)} />
              <button
